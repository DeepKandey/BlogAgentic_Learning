...
class BlogNode:
    ...
    def title_creation(self,state:BlogState):
        ...
        if "topic" in state and state["topic"]:
            prompt="""
                    ...
                    for the {topic}. This title should be creative and SEO friendly.
                    """
    ...
    def content_generation(self,state:BlogState):
        if "topic" in state and state["topic"]:
            system_prompt = """You are ann expert blog writer. Use markdown formatting.
                             Generate a detailed blog content with the breakdown for the {topic}"""
    ...
    def translation(self,state:BlogState):
        ...
        - Maintain the original tone, style, and the formatting.
